...
**Next:**
- **Retire the kubectl/docker *enrichers*** now that the probes subsume them (correlation does the escalation, stronger). `--enrich prometheus` (metric-threshold) stays.
